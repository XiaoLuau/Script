...
if ShouldTranslate then
    Translation = loadstring(game:HttpGet('https://raw.githubusercontent.com/XiaoLuau/Script/main/XATranslation.lua'))()
    if Translation then
...
task.spawn(function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/XiaoLuau/Script/main/WebHook.lua'))('XAHub')
end)
